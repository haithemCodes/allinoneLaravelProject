...
@section('main-content')
	@if(Helper::isCartCheckoutEnabled())
		<!-- Breadcrumbs -->
			...
			<div class="row">
				<div class="col-12">
					<div class="text-center py-5">
						<i class="ti-shopping-cart icon-large text-muted"></i>
						<h2 class="mt-3">Cart is Disabled</h2>
						<p class="text-muted">The shopping cart and checkout functionality is currently disabled.</p>
